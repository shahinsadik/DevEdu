...
import SeeInvitation from "@/components/dashboard/SeeInvitation";
...
const Dashboard = () => {
  ...
  const getPayLink = () => {
    if (totalAmount == 5) {
      axiosPublic
        .post("/api/check-payment-template", { template_number: 1 })
        .then((res) => {
      ...
      axiosPublic
        .post("/api/check-payment-template", { template_number: 2 })
        .then((res) => {
          if (res.data.status_code === 201) {
            window.location.href = res.data.paymentLink;
          }
      ...
      axiosPublic
        .post("/api/check-payment-template", { template_number: 3 })
        .then((res) => {
          if (res.data.status_code === 201) {
            window.location.href = res.data.paymentLink;
          }
      ...
      axiosPublic
        .post("/api/check-payment-template", { template_number: 4 })
        .then((res) => {
          if (res.data.status_code === 201) {
            window.location.href = res.data.paymentLink;
          }
      ...
      axiosPublic
        .post("/api/check-payment-template", { template_number: 5 })
        .then((res) => {
          if (res.data.status_code === 201) {
            window.location.href = res.data.paymentLink;
          }
      ...
      axiosPublic
        .post("/api/check-payment-template", { template_number: 6 })
        .then((res) => {
          if (res.data.status_code === 201) {
            window.location.href = res.data.paymentLink;
          }
      ...
      axiosPublic
        .post("/api/check-payment-template", { template_number: 7 })
        .then((res) => {
          if (res.data.status_code === 201) {
            window.location.href = res.data.paymentLink;
          }
      ...
      axiosPublic
        .post("/api/check-payment-template", { template_number: 8 })
        .then((res) => {
          if (res.data.status_code === 201) {
            window.location.href = res.data.paymentLink;
          }
      ...
      axiosPublic
        .post("/api/check-payment-template", { template_number: 9 })
        .then((res) => {
          if (res.data.status_code === 201) {
            window.location.href = res.data.paymentLink;
          }
      ...
      axiosPublic
        .post("/api/check-payment-template", { template_number: 10 })
        .then((res) => {
          if (res.data.status_code === 201) {
            window.location.href = res.data.paymentLink;
          }
      ...
      axiosPublic
        .post("/api/check-payment-template", { template_number: 11 })
        .then((res) => {
          if (res.data.status_code === 201) {
            window.location.href = res.data.paymentLink;
          }
      ...
      axiosPublic
        .post("/api/check-payment-template", { template_number: 12 })
        .then((res) => {
          if (res.data.status_code === 201) {
            window.location.href = res.data.paymentLink;
          }
      ...
      axiosPublic
        .post("/api/check-payment-template", { template_number: 13 })
        .then((res) => {
          if (res.data.status_code === 201) {
            window.location.href = res.data.paymentLink;
          }
      ...
      axiosPublic
        .post("/api/check-payment-template", { template_number: 14 })
        .then((res) => {
          if (res.data.status_code === 201) {
            window.location.href = res.data.paymentLink;
          }
      ...
      axiosPublic
        .post("/api/check-payment-template", { template_number: 15 })
        .then((res) => {
          if (res.data.status_code === 201) {
            window.location.href = res.data.paymentLink;
          }
      ...
      axiosPublic
        .post("/api/check-payment-template", { template_number: 16 })
        .then((res) => {
          if (res.data.status_code === 201) {
            window.location.href = res.data.paymentLink;
          }
      ...
      axiosPublic
        .post("/api/check-payment-template", { template_number: 17 })
        .then((res) => {
          if (res.data.status_code === 201) {
            window.location.href = res.data.paymentLink;
          }
      ...
      axiosPublic
        .post("/api/check-payment-template", { template_number: 18 })
        .then((res) => {
          if (res.data.status_code === 201) {
            window.location.href = res.data.paymentLink;
          }
      ...
      axiosPublic
        .post("/api/check-payment-template", { template_number: 19 })
        .then((res) => {
          if (res.data.status_code === 201) {
            window.location.href = res.data.paymentLink;
          }
      ...
      axiosPublic
        .post("/api/check-payment-template", { template_number: 20 })
        .then((res) => {
          if (res.data.status_code === 201) {
            window.location.href = res.data.paymentLink;
          }
      ...
      axiosPublic
        .post("/api/check-payment-template", { template_number: 21 })
        .then((res) => {
          if (res.data.status_code === 201) {
            window.location.href = res.data.paymentLink;
          }
      ...
      axiosPublic
        .post("/api/check-payment-template", { template_number: 22 })
        .then((res) => {
          if (res.data.status_code === 201) {
            window.location.href = res.data.paymentLink;
          }
      ...
      axiosPublic
        .post("/api/check-payment-template", { template_number: 23 })
        .then((res) => {
          if (res.data.status_code === 201) {
            window.location.href = res.data.paymentLink;
          }
      ...
      axiosPublic
        .post("/api/check-payment-template", { template_number: 24 })
        .then((res) => {
          if (res.data.status_code === 201) {
            window.location.href = res.data.paymentLink;
          }
      ...
      axiosPublic
        .post("/api/check-payment-template", { template_number: 25 })
        .then((res) => {
          if (res.data.status_code === 201) {
            window.location.href = res.data.paymentLink;
          }
      ...
      <div className="grid md:grid-cols-1 lg:grid-cols-3 bg-base-200 md:w-full gap-gap_primary">
        <div className="text-center lg:text-left rounded border-2 border-bg_lightSlate shadow-md bg-base-100 p-4 md:w-full flex flex-col items-center justify-center group hover:border-green-500 duration-500 relative">
          <h1 className="font-bold text-text_xl md:text-text_40px">
            {paySection ? (
              ...
              <span className="text-green-500">Payment for Mejban</span>
            )}
          </h1>
        ...
        <div className="text-center  lg:text-left card rounded border-2 border-bg_lightSlate shadow-md bg-base-100 p-4 hover:border-green-500 group relative">
          ...
          <div className="flex items-center justify-center z-0 absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
            ...
            width={500}
              src={logo}
              className=" opacity-0 group-hover:opacity-10 duration-500 bg-cover"
              alt=""
            />
          </div>
        </div>
        ...
        <div className="rounded border-2 border-bg_lightSlate shadow-md bg-base-100 hover:border-green-500 h-full w-full overflow-hidden group p-4 relative flex items-center">
          ...
          height={500}
          width={500}
          className= " bg-cover w-full h-full object-cover" src={mejban} alt="" />
          <div className="flex items-center justify-center absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
            <Image
            height={500}
            width={500}
